...
const PUBLIC_NAV_ITEMS = [
  { label: "navigation.dashboard", href: "/dashboard", icon: Home },
  { label: "navigation.properties", href: "/properties", icon: Building2 },
  { label: "navigation.kpr", href: "/kpr-calculator", icon: Calculator },
  { label: "navigation.surveys", href: "/surveys", icon: CalendarCheck },
  { label: "navigation.contact", href: "/support", icon: PhoneCall },
];
            ...
            const isActive =
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "px-3 py-2 text-xs lg:text-sm font-semibold rounded-full transition-all flex items-center gap-1.5",
                    isActive
                      ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400"
                      : "text-muted-foreground hover:bg-muted/80 hover:text-foreground"
                  )}
                >
                  <item.icon className="w-3.5 h-3.5 lg:w-4 lg:h-4 opacity-70" />
                  {t(item.label as any)}
                </Link>
              );
          })}
          ...
          {isLoggedIn ? (
            ...
            <Link href="/login">
                  ...
                  >
                    ...
                    <span>{t("navigation.dashboard")} ERP</span>
                  </Button>
            </Link>
          )}
        </div>
