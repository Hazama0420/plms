...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default:
          "h-10 gap-2 px-4 rounded-xl text-sm font-semibold shadow-xs [&_svg:not([class*='size-'])]:size-4",
        sm:
          "h-8 gap-1.5 px-3 rounded-lg text-xs font-medium in-data-[slot=button-group]:rounded-lg [&_svg:not([class*='size-'])]:size-3.5",
        xs:
          "h-6 gap-1 rounded-md px-2 text-[11px] in-data-[slot=button-group]:rounded-lg [&_svg:not([class*='size-'])]:size-3",
        lg:
          "h-11 gap-2.5 px-5 rounded-xl text-sm font-bold shadow-sm [&_svg:not([class*='size-'])]:size-4.5",
